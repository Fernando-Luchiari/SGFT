...
<form name="frmcpf" method="post" action="ServletAcesso" onSubmit="VerificaCPF();">
  <div align="center">
    ...
    <table width="938" border="1">
        <tr>
          ...
          <td width="591">  <h5 align="center" class="style2">Um novo conceito para genrenciamento de chamadas de t&aacute;xi </h5></td>
        </tr>
      </table>
  </div>
  <p>&nbsp;</p>
  <div align="center">
    <table width="490" border="1">
      <tr>
        <td height="51"><p align="center" class="style2"><strong>Seja bem vindo ao SGCT.<br>
          Insira seu usu&aacute;rio e sua senha para acessar o sistema. </strong></p>          </td>
        </tr>
      <tr>
        <td width="473"><div align="center">
          <table width="305" height="131" border="1">
            <tr>
