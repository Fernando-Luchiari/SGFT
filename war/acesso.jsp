...
<title>Sistema de Gerenciamento de Chamados de Táxi</title>
...
<form name="frmcpf" method="post" action="ServletAcesso" >
  <div align="center">
    <input type="hidden" name="operacao" value="AcessoUsuario">
    <table width="938" border="0" >
        <tr>
          <td width="331"><img src="logopretoinicio.png" width="247" height="80"></td>
          <td width="591"><div align="center" class="style5 style6">Um novo conceito em ger&ecirc;ncia de chamados de t&aacute;xi </div></td>
        </tr>
      </table>
  </div>
  <p>&nbsp;</p>
  <div align="center">
    <table width="490" border="0">
      <tr>
        <td height="66" border="0"><p align="center" class="style2"><strong>Seja bem vindo ao SGCT.<br>
          Insira seu usu&aacute;rio e sua senha para acessar o sistema. </strong></p>          </td>
        </tr>
      <tr>
        <td width="473">
          <div align="left">
            <table width="126" height="165" border="0">
              <tr>
                <th width="5" height="5" nowrap border="0" ><div align="left"><span class="style2">Usu&aacute;rio:</span>
                  <input type="text" name="txtLogin" size="18">
                </div></th>
                </tr>
              <tr>
                <th width="5" height="5" nowrap border="0" ><div align="left">
                  <label></label>
                  </div></th>
                </tr>
              <tr>
                <th width="5" height="5" nowrap border="0"><div align="left"><span class="style2"><strong>Senha:
                  <input type="password" name="txtSenha" size="18">
                </strong></span></div></th>
                </tr>
              <tr>
                <th width="5" height="5" nowrap border="0"><input type="submit" name="Submit" value="LOGIN"></th>
                </tr>
            </table>
          </div></td></tr>
    </table>
